...
describe('ProtectedRoute', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      renderWithProviders(<ProtectedRoute {...defaultProps} />);
    });

    it('renders with default props', () => {
      const { container } = renderWithProviders(<ProtectedRoute {...defaultProps} />);
...
describe('PublicRoute', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      renderWithProviders(<PublicRoute {...defaultProps} />);
    });

    it('renders with default props', () => {
      const { container } = renderWithProviders(<PublicRoute {...defaultProps} />);
      expect(container.firstChild).toBeInTheDocument();
    });
  });
